...
export default function BranchForm({ mode, initialData }: BranchFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const url =
        mode === "create" ? "/api/branches" : `/api/branches/${initialData?.id}`;
      ...
      if (!res.ok || !data.ok) {
        setError(data.message || "Lưu chi nhánh thất bại");
        return;
      }
